...
### images
The images folder contains 350 images of autorickshaws. Each images file has a number in its filename.


### bbs
The bbs folder contains bbs.json file, which contain the ground truth bounding boxes. It is an array of lenth 350. The bounding box information corresponding to the image i.jpg can be found at the ith location in bbs array. 
